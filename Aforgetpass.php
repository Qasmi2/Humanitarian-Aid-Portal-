...
if(isset($_POST['btn-submit']))
{
	...
	if($stmt->rowCount() == 1)
	{
		...
		$message= "
				   ...
				   <br /><br />
				   <a href='http://localhost/ExtendFYP/AReSetpass.php?id=$id&code=$code'>click here to reset your password</a>
				   <br /><br />
				   thank you :)
				   ";
  ...
  <body id="login">
    <div class="container">
      ...
      <form class="form-signin" method="post">
        ...
        <br/><hr/>
        <a href="index.html">Main Page </a>  <a href="AsignIn.php">SignIn </a> <a href="Asignup.php">Signup</a>
      </form>
